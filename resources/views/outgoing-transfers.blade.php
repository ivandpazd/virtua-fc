                                ...
                                <div class="overflow-x-auto">
                                    <table class="w-full text-sm">
                                        ...
                                        @php
                                            ...
                                            $flags = $playerFlags[$player->id] ?? ['stature_gap' => false, 'wage_gap' => false];
                                            $hasStatureGap = $flags['stature_gap'];
                                            $hasWageGap = $flags['wage_gap'];
                                        @endphp
                                        @php
                                        ...
                                        <tr x-data class="border-t border-border-default transition-colors cursor-pointer {{ $hasPendingOffer ? 'bg-accent-red/10' : 'hover:bg-[rgba(59,130,246,0.05)]' }}"
                                            ...
                                            <td class="py-2.5 pl-2 pr-3">
                                                <div class="flex items-center gap-1.5">
                                                    ...
                                                    @endif
                                                    @if($hasStatureGap)
                                                        <x-warning-triangle :tooltip="__('transfers.player_wont_renew')" size="w-3.5 h-3.5" class="text-accent-red" />
                                                    @elseif($hasWageGap)
                                                        <x-warning-triangle :tooltip="__('transfers.player_wants_raise')" size="w-3.5 h-3.5" class="text-accent-gold" />
                                                    @endif
                                                </div>
                                                @if($hasPendingOffer)
