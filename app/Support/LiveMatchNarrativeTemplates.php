...
class LiveMatchNarrativeTemplates
{
    ...
    private static function atmosphere(): array
    {
        return [
            ...
            'contextualHomeLeadingHomeOnly' => __('commentary.contextual_home_leading_home_only'),
            'contextualAwayLeading' => __('commentary.contextual_away_leading'),
            'contextualAwayLeadingHomeOnly' => __('commentary.contextual_away_leading_home_only'),
            'contextualHomeDominant' => __('commentary.contextual_home_dominant'),
            'contextualHomeDominantHomeOnly' => __('commentary.contextual_home_dominant_home_only'),
    ...
    private static function summary(): array
    {
        return [
            ...
            'summaryOpeningHomeWinHomeOnly' => __('match_summary.opening_home_win_home_only'),
            'summaryOpeningAwayWin' => __('match_summary.opening_away_win'),
            'summaryOpeningAwayWinHomeOnly' => __('match_summary.opening_away_win_home_only'),
