...
return [
    ...
    'today' => 'Today',
    'jump_to_next' => 'Jump to next match',
    ...
    'pressing_tip_high_press' => 'Creates many chances and greatly reduces opponent goals, but fades after minute 55 and becomes vulnerable. Exhausting.',
    'pressing_tip_standard' => 'No modifiers. Balanced pressing.',
    'pressing_tip_low_block' => 'Significantly fewer goals for you, but also significantly fewer for opponent. Very light on energy.',
    'pressing_summary_high_press' => 'Suffocate the opponent early. Dominant but exhausting — fades after minute 55 and leaves you exposed.',
    'pressing_summary_standard' => 'Balanced pressing with no bonuses.',
    'pressing_summary_low_block' => 'Defend deep in numbers. Very hard to break down but limits your own attack. Saves the most energy.',

    // Defensive Line
    'defline_high_line' => 'High Line',
    'defline_normal' => 'Normal',
    'defline_deep' => 'Deep Line',
    'defline_tip_high_line' => 'Significantly more goals for you, fewer for opponent.',
    'defline_tip_normal' => 'No modifiers. Balanced defensive line.',
    'defline_tip_deep' => 'Significantly fewer goals conceded, but also significantly fewer created.',
    'defline_summary_high_line' => 'Squeeze the pitch. Strong attacking boost but leaves space behind.',
    'defline_summary_normal' => 'Balanced defensive line.',
    'defline_summary_deep' => 'Drop deep and compact. Very hard to score against, but limits your own attack.',
    ...
    'tg_high_press_vs_deep_desc' => 'High pressing loses effectiveness when the opponent sits deep — there is no high line to press against.',
    'tg_counter_vs_low_block_desc' => 'Counter-attacking teams struggle against a low block — there is no space behind to exploit on the break.',
    'tg_possession_vs_deep_low_block_desc' => 'Possession play is frustrated by an opponent combining a deep line with a low block — the defensive wall is very hard to break down.',
    'tg_direct_vs_deep_desc' => 'Direct long balls bypass a deep defensive line, creating chances over the top.',
    'tg_high_line_high_press_synergy_desc' => 'Combining a high line with high pressing creates a coordinated squeeze that generates more chances.',
    'tg_attacking_high_line_vulnerability_desc' => 'Playing with an attacking mentality and a high line leaves space behind for any opponent to exploit.',
    'tg_pressing_fade_note' => 'High Press effectiveness fades linearly from minute 55 to 90, and actually becomes a vulnerability as players tire.',
    'tg_high_line_note' => '',
    ...
    'live_stat_passes' => 'Passes',
    'live_stat_corners' => 'Corners',
    'live_stat_offsides' => 'Offsides',
    ...
    'sub_free_window' => 'Half-time — free substitution window',
    ...
    'sub_formation_prompt_title' => 'Your formation doesn\'t fit this substitution',
    'sub_formation_prompt_body' => 'At least one player would be played out of position (25% rating penalty). Pick a formation that fits, or keep the current one and accept the penalty.',
    'sub_formation_prompt_pick' => 'Pick a formation',
    'sub_formation_suggested' => 'Suggested',
    'sub_formation_keep_with_penalty' => 'Keep current formation (with penalty)',
    'sub_formation_loading' => 'Finding the best-fit formation...',
    ...
    'pitch_tap_or_drag' => 'Tap to substitute · Drag to swap roles',
    ...
    'pro_manager_pick_intro' => 'Four Primera RFEF clubs are willing to take a chance on you. Pick the one you want to start your career with.',
